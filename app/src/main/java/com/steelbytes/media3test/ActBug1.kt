...
import com.steelbytes.media3test.databinding.Actbug1Binding

/*

Media3 1.5.1
ExoPlayer.release with any setEffects causes leak on second release
https://github.com/androidx/media/issues/2016

*/

@Suppress("DEPRECATION", "OVERRIDE_DEPRECATION")
@SuppressLint("UnsafeOptInUsageError")
class ActBug1 : ActBase(), View.OnClickListener {

    private lateinit var binding: Actbug1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = Actbug1Binding.inflate(layoutInflater)
